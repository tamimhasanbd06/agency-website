    ...
    return (
        <div className='bg-[#F2F3F8]'>
            <div className='max-w-screen-2xl container mx-auto py-20 px-5'>
                ...
                {/* teme member cerds */}
                <div className='grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-10 my-10'>
                    {
                        teamMembers.map((member, index) => (
                            <div key={index} className='bg-white shadow-lg rounded-lg 
                            overflow-hidden transition-all hover:shadow-xl'>
                                <img src={member.image} alt={member.name} className='w-full h-56
                                object-cover'/>
                                ...
                                <div className='p-5'>
                                    ...
                                    <div className='flex space-x-4 mb-5 items-center'>
                                        <Link to={member.linkedIn}><FaLinkedinIn
                                            className='text-blue-600 hover:text-blue-800' />
                                        </Link>

                                        <Link to={member.twitter}><FaTwitter
                                            className='text-blue-600 hover:text-blue-800' />
                                        </Link>

                                        <Link to={member.instagram}><FaInstagram
                                            className='text-blue-600 hover:text-blue-800' />
                                        </Link>

                                        <Link to={member.facebook}><FaFacebookF
                                            className='text-blue-600 hover:text-blue-800' />
                                        </Link>
                                    </div>
                                    ...
                                    rounded-full hover:bg-blue-700 transition duration-300'>
