...
const pricingPlans = [
  {
    name: "Freelancer",
    monthlyPrice: 25,
    yearlyPrice: 250, // 25 * 10 (10 মাসের সমান ডিসকাউন্ট)
      ...
      <div className="text-center mb-10">
        <label className="inline-flex items-center cursor-pointer">
          ...
          <div className="relative">
            ...
            <div
              className={`toggle-circle absolute top-1 left-1 w-6 h-6
              bg-blue-600 rounded-full transition-transform duration-300
