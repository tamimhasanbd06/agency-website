        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              ...
              className="flex w-full items-center px-4 py-2 space-x-2 text-white bg-red-500 rounded hover:bg-red-600 transition"
            >
              <FaGoogle />
              <span>Google</span>
            </button>

            <button className="flex w-full items-center px-4 py-2 space-x-2 text-white bg-gray-800 rounded hover:bg-gray-900 transition">
              <FaGithub />
              <span>GitHub</span>
            </button>

            <button className="flex w-full items-center px-4 py-2 space-x-2 text-white bg-blue-500 rounded hover:bg-blue-600 transition">
              <FaFacebook />
              <span>Facebook</span>
            </button>
          </div>
