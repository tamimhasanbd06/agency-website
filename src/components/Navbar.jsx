...
const Navbar = () => {
    const { user, logout } = useAuth(); // এখানে () জরুরি
    console.log(user);

    const handleLogOut = () => {
        logout(); // এখানে সঠিক কল
    }
            ...
            <div className="navbar-end space-x-4">
                {user ? (
                    <>
                        ...
                        <button onClick={handleLogOut} className="btn btn-primary bg-primary text-white">Logout</button>
                    </>
                ) : (
                    <>
